...
// 各セクションの展開状態
// CategorySelect に統一したため、各表示切替フラグは不要

// CategorySelect が内部でタブ管理するため不要
...
// 言語を追加する関数（話せる言語）
// 話せる言語の追加/削除は CategorySelect に委譲

// 言語を追加する関数（学びたい言語）
// 学びたい言語の追加/削除は CategorySelect に委譲
